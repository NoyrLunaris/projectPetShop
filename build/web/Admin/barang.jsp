<%-- 
    Document   : barang
    Created on : Nov 16, 2019, 4:15:06 PM
    Author     : asus
--%>
	...
	<div id="header-wrapper">
		<div id="header">
			<div id="logo">
				<h1>MyDoggo</h1>
                                <br>
                                <p> Welcome Admin PetShop </p>
			</div>
		</div>
	</div>
	<!-- end #header -->
	<%@include file="../Tools/HeaderAdmin.jsp" %>
	<!-- end #menu -->
	<div id="page">
		<div id="content">
                        <h1>Tabel Barang</h1>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>10000</td>
                                <td>100</td>
                                <th><a href=""><input type="button" value="Update"></a> | <a href=""><input type="button" value="Delete"></a></th>
                            </tr>
                            <tr>
                                <td>B02</td>
                                <td>Gambar</td>
